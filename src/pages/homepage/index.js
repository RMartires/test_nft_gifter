...
import FunggyLogo from "../../images/FungyyLogo.jpg";
                    ...
                    <section class="hero">
                        <div class="container">
                            <div class="hero-inner">
                                <div class="hero-copy">
                                    <h1 class="hero-title mt-0 is-revealing">TophatTurtle</h1>
                                    <p class="hero-paragraph is-revealing">Making NFTs accessable to everyone.</p>
                                    <div class="hero-form field field-grouped is-revealing">
                                        ...
                                        {sent ? (
                                            <div>
                                                <br />
                                                <p>Thanks, will get back to you</p>
                                            </div>
                                        ) : (
                                            <div class="control">
                                    ...
                                    <div class="feature">
                                        <div class="feature-inner">
                                            <div class="feature-header mb-16">
                                                ...
                                                <h4 class="feature-title m-0">User Friendly</h4>
                                            </div>
                                            <p class="text-sm mb-0">
                                                increase NFT adoption by reducing user friction,
                                                we send 'em via Email
                                            </p>
                                        </div>
                                    </div>
                                    <div class="feature">
                                        <div class="feature-inner">
                                            ...
                                            <p class="text-sm mb-0">
                                                your users NFTs are kept safe in out smart-contract
                                                and only accessble to the user
                                            </p>
                                        </div>
                                    </div>
                                    <div class="feature">
                                        <div class="feature-inner">
                                            <div class="feature-header mb-16">
                                                ...
                                                <h4 class="feature-title m-0">MultiChain Integration</h4>
                                            </div>
                                            <p class="text-sm mb-0">
                                                we can host ur NFTs from most popular chains
                                            </p>
                                        </div>
                                    </div>
                                </div>
